...
static inline bool tryAxis(
    const cyclone::CollisionBox &one,
    const cyclone::CollisionBox &two,
    cyclone::Vector3& axis,
    const cyclone::Vector3& toCentre,
    unsigned index,

    // These values may be updated
    cyclone::real& smallestPenetration,
...
static inline bool overlapOnAxis(
    const cyclone::CollisionBox &one,
    const cyclone::CollisionBox &two,
    const cyclone::Vector3 &axis,
    const cyclone::Vector3 &toCentre
    );

static inline cyclone::real penetrationOnAxis(
    const cyclone::CollisionBox &one,
    const cyclone::CollisionBox &two,
    const cyclone::Vector3 &axis,
    const cyclone::Vector3 &toCentre
...
static inline cyclone::Vector3 contactPoint(
    const cyclone::Vector3 &pOne,
    const cyclone::Vector3 &dOne,
    cyclone::real oneSize,
    const cyclone::Vector3 &pTwo,
    const cyclone::Vector3 &dTwo,
    cyclone::real twoSize,
